...
<header class="flex justify-center items-center py-4 bg-gray-700 text-white">
    <h1 class="text-4xl sm:text-2xl font-bold">SISTEM INFORMASI MAHASISWA</h1>
</header>

<nav class="flex flex-col sm:flex-row justify-between items-center py-2 bg-gray-600 text-white">
...
<div class="mt-4 bg-white shadow-lg rounded p-4">
    ...
    <h2 class="text-2xl sm:text-xl font-bold text-center">List Mahasiswa</h2>
